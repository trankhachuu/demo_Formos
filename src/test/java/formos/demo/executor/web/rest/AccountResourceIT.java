...
import static formos.demo.executor.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import formos.demo.executor.service.UserService;
import formos.demo.executor.dto.AdminUserDTO;
import formos.demo.executor.dto.PasswordChangeDTO;
import formos.demo.executor.dto.KeyAndPasswordRequestDTO;
import formos.demo.executor.dto.ManagedUserRequestDTO;
...
class AccountResourceIT {
    ...
    void testRegisterValid() throws Exception {
        ManagedUserRequestDTO validUser = new ManagedUserRequestDTO();
    ...
    void testRegisterInvalidLogin() throws Exception {
        ManagedUserRequestDTO invalidUser = new ManagedUserRequestDTO();
    ...
    void testRegisterDuplicateLogin() throws Exception {
        // First registration
        ManagedUserRequestDTO firstUser = new ManagedUserRequestDTO();
        ...
        ManagedUserRequestDTO secondUser = new ManagedUserRequestDTO();
    ...
    void testRegisterDuplicateEmail() throws Exception {
        ...
        ManagedUserRequestDTO userWithUpperCaseEmail = new ManagedUserRequestDTO();
    ...
    void testChangePasswordTooSmall() throws Exception {
        ...
        String newPassword = RandomStringUtils.random(ManagedUserRequestDTO.PASSWORD_MIN_LENGTH - 1);
    ...
    void testChangePasswordTooLong() throws Exception {
        ...
        String newPassword = RandomStringUtils.random(ManagedUserRequestDTO.PASSWORD_MAX_LENGTH + 1);
    ...
    void testFinishPasswordReset() throws Exception {
        ...
        KeyAndPasswordRequestDTO keyAndPassword = new KeyAndPasswordRequestDTO();
