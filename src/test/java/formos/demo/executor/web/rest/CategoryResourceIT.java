...
import formos.demo.executor.repository.CategoryRepository;
...
class CategoryResourceIT {
    ...
    private static final Boolean DEFAULT_STAUTUS = false;
    private static final Boolean UPDATED_STAUTUS = true;
    ...
    public static Category createEntity(EntityManager em) {
        Category category = new Category().name(DEFAULT_NAME).stautus(DEFAULT_STAUTUS);
        return category;
    }
    ...
    public static Category createUpdatedEntity(EntityManager em) {
        Category category = new Category().name(UPDATED_NAME).stautus(UPDATED_STAUTUS);
        return category;
    }
    ...
    void createCategory() throws Exception {
        ...
        assertThat(testCategory.getStautus()).isEqualTo(DEFAULT_STAUTUS);
    }
    ...
    void getAllCategories() throws Exception {
        ...
        restCategoryMockMvc
            ...
            .andExpect(jsonPath("$.[*].stautus").value(hasItem(DEFAULT_STAUTUS.booleanValue())));
    }
    ...
    void getCategory() throws Exception {
        ...
        restCategoryMockMvc
            ...
            .andExpect(jsonPath("$.stautus").value(DEFAULT_STAUTUS.booleanValue()));
    }
    ...
    void putNewCategory() throws Exception {
        ...
        updatedCategory.name(UPDATED_NAME).stautus(UPDATED_STAUTUS);
        ...
        assertThat(testCategory.getStautus()).isEqualTo(UPDATED_STAUTUS);
    }
    ...
    void fullUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.name(UPDATED_NAME).stautus(UPDATED_STAUTUS);
