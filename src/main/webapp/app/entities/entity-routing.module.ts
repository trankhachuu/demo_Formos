...
@NgModule({
  imports: [
    RouterModule.forChild([
      ...
      {
        path: 'menu',
        data: { pageTitle: 'beerApp.menu.home.title' },
        loadChildren: () => import('./menu/beer-menu.module').then(m => m.BeerMenuModule),
      },
      {
        path: 'menu',
        data: { pageTitle: 'formosBeerApp.menu.home.menuList' },
        loadChildren: () => import('./menu/beer-menu.module').then(m => m.BeerMenuModule),
      },
